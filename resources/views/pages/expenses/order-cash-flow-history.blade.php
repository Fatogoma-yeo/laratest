                            ...
                            <table class="table border border-gray-500 w-full">
                                ...
                                <tbody>
                                    @forelse ($cash_flow_history as $history)
                                        <tr :class="@if($history->operation === 'debit' && $history->status == 'active') 'bg-green-200' @elseif($history->operation === 'debit' && $history->status == 'inactive') 'bg-blue-200'@endif" class="text-sm">
